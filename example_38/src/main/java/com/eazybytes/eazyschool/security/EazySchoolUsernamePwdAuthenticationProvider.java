...
public class EazySchoolUsernamePwdAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    public EazySchoolUsernamePwdAuthenticationProvider(PersonRepository personRepository) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if(null != person && person.getPersonId()>0 && password.equals(person.getPassword())) {
